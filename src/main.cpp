...
#define TOKEN               "gjc20ZNa4ccCEceqQwsh"
#define THINGSBOARD_SERVER  "34.93.176.13"
...
delay(2000);
  ...
  tb.sendTelemetryInt("temperature", bmp.readTemperature());
  tb.sendTelemetryInt("pressure", bmp.readPressure());
  tb.sendTelemetryInt("altitude", bmp.readAltitude());
  tb.sendTelemetryInt("pressuresea", bmp.readSealevelPressure());
    delay(100);
